...
let [D_TEXT_ENCODER, D_TEXT_DECODER]
	= 'undefined' === typeof Buffer
		? ('undefined' === typeof TextEncoder
			? [new (require('util').TextEncoder)(), new (require('util').TextDecoder)()]
...
const decode_utf_8 = at_chunk => D_TEXT_DECODER.decode(at_chunk);
...
class buffer_encoder {
	...
	constructor(h_config={}, kb=null) {
		Object.assign(this, {buffer:kb || new buffer_writer(h_config)});
	}
	...
	vuint(x_value) {
		...
		throw new Error('encoding integer of 6 bytes or more not supported');
	}
...
class buffer_decoder {
	...
	byte() {
		return this.contents[this.read++];
	}
	...
	typed_array() {
		...
		return new H_ENCODING_TO_TYPED_ARRAY[x_type](at_contents.buffer, at_contents.byteOffset, nl_values);
	}
